                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0" id="slide-layer-5"
                                 ...
                                 data-responsive_offset="on"
                                 data-elementdelay="0.05"
                                 style="z-index: 5; white-space: nowrap; letter-spacing: 1.38px; color:#fff; font-weight: 600;  font-family: 'Poppins', sans-serif;">Nepal records seven covid cases
                                <br>on Sunday According to  <br> Ministry of health
                            </div>
                    ...
                    <div class="col-md-7 col-sm-6 col-xs-6 rcnt-review-left">
                        <div class="type-post">
                            <div class="entry-cover">
                                <a href="#"><img src="./uploads/<?php echo $r['photo'];  ?>" alt="Recent" /></a>
                            ...
                            <div class="post-meta">
                                <div class="post-time"><a href="#"><?php $times = $r['newsTime']; echo time_elapsed_string($times);?></a></div>
                    ...
                    <div class="col-md-5 col-sm-6 col-xs-6 rcnt-review-right">
                        ...
                        while ($row = mysqli_fetch_assoc($sub))
                        {
                            ...
                            <div class="rcnt-review-thumb">
                                <div class="entry-cover">
                                    <a href="#"><img src="./uploads/<?php echo $row['photo'];  ?>" alt="Reviews" width="200" /></a>
                                ...
                                <div class="post-meta">
                                    <div class="post-time"><a href="#"><?php $times = $row['newsTime']; echo time_elapsed_string($times);?></a></div>
