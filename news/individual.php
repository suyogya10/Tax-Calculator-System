    ...
    <main class="site-main page_spacing">
        ...
        <div class="container">
            ...
            <div class="row blog-single">
                ...
                <div class="col-md-9 col-sm-8 content-area content_space">
                    <article class="type-post">
                        <div class="entry-cover">
                            <a href="#"><img src="./uploads/<?php echo $r['photo'];  ?>" alt="Blog" /></a>
                        </div>
                ...
                <!-- Widget Area -->
                <div class="col-md-3 col-sm-4 widget-area widget_space" style="background-color: #e3e3e3">

                    <!-- Widget: Latest Posts -->

                    <aside class="widget widget_latestposts" style="text-align: justify">
                        <form method="post"  action="individual.php?nid=<?php echo $_GET['nid']; ?>">
                            <h3 class="widget-title">Post Comment</h3>
                            <div class="side">
                                <div class="breadcrumb-item active"><h5>Full Name</h5>
                                    <input class="one" type="text" id="fname" name="fname" placeholder="" required><br>
                                </div>
                            </div>
                            <div class="side">
                                <div class="breadcrumb-item active"><h5>Email</h5>
                                    <input class="one" type="text" id="email" name="email" placeholder="" required><br>
                                </div>
                            </div>
                            <div class="side">
                                <div class="breadcrumb-item active"><h5>Comment</h5>
                                    <textarea class="two" type="text" id="cmt" name="cmt" placeholder="" required></textarea><br>
                                </div>
                                <div>
                                </div>
                                <br>
                    ...
                    <aside class="widget widget_latestposts" style="text-align: justify" >COMMENTS
                        <div>
                            <?php
                            ...
                            ?>
                            <br>
                            <div class="breadcrumb-item active" style="text-align: left"><h4><?php echo $mr['fname'];?>:</h4>
